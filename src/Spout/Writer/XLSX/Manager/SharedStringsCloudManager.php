 ...
 */
class SharedStringsCloudManager
{
...
EOD;
     ...
     */
    public function __construct($xlFolder, $stringsEscaper, $disk)
    {
        ...
        Storage::disk($disk)->append($this->sharedStringsFilePointer, $header);
...
//        Storage::disk($this->disk)->append($this->sharedStringsFilePointer, '</sst>');
...
//        Storage::disk($this->disk)->append($this->sharedStringsFilePointer, \sprintf("%-{$defaultStringsCountPartLength}s", 'count="99999999999999999999999999999999999" uniqueCount="99999999999999999999999999999999999"'));
    }
}
